...
@pytest.fixture
def intezer_static_class_instance():
    create_tmp_manifest()
    try:
        from intezer_static import IntezerStatic
        yield IntezerStatic()
    finally:
        remove_tmp_manifest()
...
class TestIntezerStatic:
    ...
    @staticmethod
    def test_init(intezer_static_class_instance):
        assert intezer_static_class_instance.client is None

    @staticmethod
    def test_start(intezer_static_class_instance, dummy_api_interface_class, mocker):
        from intezer_static import ALIntezerApi
        mocker.patch.object(intezer_static_class_instance, "get_api_interface", return_value=dummy_api_interface_class)
        intezer_static_class_instance.start()
        assert isinstance(intezer_static_class_instance.client, ALIntezerApi)
        assert True

    @staticmethod
    def test_stop(intezer_static_class_instance):
        intezer_static_class_instance.stop()
        assert True

    @staticmethod
    @pytest.mark.parametrize("sample", samples)
    def test_execute(sample, intezer_static_class_instance, dummy_api_interface_class, dummy_get_response_class, mocker):
    ...
    def test_get_analysis_metadata(intezer_static_class_instance, dummy_api_interface_class, mocker):
        ...
        assert intezer_static_class_instance._get_analysis_metadata("", "blah") == analysis_metadata
        assert intezer_static_class_instance._get_analysis_metadata(
    ...
    def test_process_details(details, uninteresting_keys, expected_output):
        from intezer_static import IntezerStatic
        assert IntezerStatic._process_details(details, uninteresting_keys) == expected_output

    @staticmethod
    def test_set_heuristic_by_verdict(intezer_static_class_instance):
        from assemblyline_v4_service.common.result import ResultSection
        result_section = ResultSection("blah")
        intezer_static_class_instance._set_heuristic_by_verdict(result_section, None)
        assert result_section.heuristic is None

        intezer_static_class_instance._set_heuristic_by_verdict(result_section, "blah")
        assert result_section.heuristic is None

        intezer_static_class_instance._set_heuristic_by_verdict(result_section, "trusted")
        assert result_section.heuristic is None

        intezer_static_class_instance._set_heuristic_by_verdict(result_section, "malicious")
        assert result_section.heuristic.heur_id == 1

        result_section = ResultSection("blah")
        intezer_static_class_instance._set_heuristic_by_verdict(result_section, "known_malicious")
        assert result_section.heuristic.heur_id == 1

        result_section = ResultSection("blah")
        intezer_static_class_instance._set_heuristic_by_verdict(result_section, "suspicious")
        assert result_section.heuristic.heur_id == 2

        result_section = ResultSection("blah")
        intezer_static_class_instance._set_heuristic_by_verdict(result_section, "interesting")
        assert result_section.heuristic.heur_id == 3

    @staticmethod
    def test_process_iocs(intezer_static_class_instance, dummy_api_interface_class, mocker):
        from intezer_static import ALIntezerApi
        ...
        mocker.patch.object(ALIntezerApi, "get_iocs", return_value={"files": [], "network": []})
        intezer_static_class_instance._process_iocs("blah", file_verdict_map, parent_res_sec)
    ...
    @staticmethod
    def test_process_ttps(intezer_static_class_instance, dummy_api_interface_class, mocker):
        from intezer_static import ALIntezerApi
        from intezer_sdk.api import IntezerApi
    ...
    @staticmethod
    def test_handle_subanalyses(intezer_static_class_instance, dummy_request_class, dummy_api_interface_class, mocker):
        ...
        mocker.patch.object(intezer_static_class_instance.client, "get_sub_analyses_by_id", return_value=[])
        parent_result_section = ResultSection("blah")
        intezer_static_class_instance._handle_subanalyses(
            dummy_request_class(), "blah", "blah", {}, parent_result_section)
        assert parent_result_section.subsections == []

        mocker.patch.object(
            intezer_static_class_instance.client,
        ...
        mocker.patch.object(intezer_static_class_instance, "_process_families")
        mocker.patch.object(intezer_static_class_instance.client, "download_file_by_sha256", return_value=True)
    ...
    def test_process_families(families, file_verdict_map, correct_fvp, intezer_static_class_instance):
        ...
        intezer_static_class_instance._process_families(families, "blah", file_verdict_map, parent_section)
    ...
    def test_process_extraction_info(intezer_static_class_instance):
        ...
        intezer_static_class_instance._process_extraction_info(processes, process_path_set, command_line_set, so)
